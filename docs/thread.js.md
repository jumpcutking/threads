...
* [@jumpcutking/threads/src/thread](#module_@jumpcutking/threads/src/thread)
    ...
    * [~JSONstringify](#module_@jumpcutking/threads/src/thread..JSONstringify)
    * [~options](#module_@jumpcutking/threads/src/thread..options)
    * [~buffer](#module_@jumpcutking/threads/src/thread..buffer)
    * [~isDebug()](#module_@jumpcutking/threads/src/thread..isDebug) ⇒ <code>boolean</code>
...
<a name="module_@jumpcutking/threads/src/thread..JSONstringify"></a>

### @jumpcutking/threads/src/thread~JSONstringify
...
**Kind**: inner property of [<code>@jumpcutking/threads/src/thread</code>](#module_@jumpcutking/threads/src/thread)  
<a name="module_@jumpcutking/threads/src/thread..isDebug"></a>

### @jumpcutking/threads/src/thread~isDebug() ⇒ <code>boolean</code>
...
**Returns**: <code>boolean</code> - True if the thread is in debug mode.  
